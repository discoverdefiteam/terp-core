...
// source: terp/claim/params.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "terp.claim.V2Params")
	proto.RegisterType((*Airdrop)(nil), "terp.claim.V2Airdrop")
}

func init() { proto.RegisterFile("terp/claim/params.proto", fileDescriptor_dd7ac871d3875dc3) }
