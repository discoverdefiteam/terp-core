...
// TerpPeriodicVestingAccount implements the VestingAccount interface. It
// periodically vests by unlocking coins during each specified period.
type TerpPeriodicVestingAccount struct {
...
func (m *TerpPeriodicVestingAccount) Reset()      { *m = TerpPeriodicVestingAccount{} }
func (*TerpPeriodicVestingAccount) ProtoMessage() {}
func (*TerpPeriodicVestingAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_41f0278a453c26b3, []int{2}
}
func (m *TerpPeriodicVestingAccount) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TerpPeriodicVestingAccount) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TerpPeriodicVestingAccount.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TerpPeriodicVestingAccount) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TerpPeriodicVestingAccount.Merge(m, src)
}
func (m *TerpPeriodicVestingAccount) XXX_Size() int {
	return m.Size()
}
func (m *TerpPeriodicVestingAccount) XXX_DiscardUnknown() {
	xxx_messageInfo_TerpPeriodicVestingAccount.DiscardUnknown(m)
}

var xxx_messageInfo_TerpPeriodicVestingAccount proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*TerpPeriodicVestingAccount)(nil), "stride.vesting.TerpPeriodicVestingAccount")
}
...
func (m *TerpPeriodicVestingAccount) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TerpPeriodicVestingAccount) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TerpPeriodicVestingAccount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TerpPeriodicVestingAccount) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TerpPeriodicVestingAccount) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TerpPeriodicVestingAccount: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TerpPeriodicVestingAccount: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
