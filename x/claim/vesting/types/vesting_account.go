...
import (
	...
	"github.com/terpnetwork/terp-core/terputils"
	vestexported "github.com/terpnetwork/terp-core/x/claim/vesting/exported"
)

// Compile-time type assertions
var (
	_ authtypes.AccountI          = (*BaseVestingAccount)(nil)
	_ vestexported.VestingAccount = (*TerpPeriodicVestingAccount)(nil)
)
...
// Periodic Vesting Account (only for terp)
// This vesting account works differently from the core periodic vesting account.
var _ vestexported.VestingAccount = (*TerpPeriodicVestingAccount)(nil)
var _ authtypes.GenesisAccount = (*TerpPeriodicVestingAccount)(nil)

// NewTerpPeriodicVestingAccountRaw creates a new TerpPeriodicVestingAccount object from BaseVestingAccount
func NewTerpPeriodicVestingAccountRaw(bva *BaseVestingAccount, startTime int64, periods Periods) *TerpPeriodicVestingAccount {
	return &TerpPeriodicVestingAccount{
		BaseVestingAccount: bva,
		VestingPeriods:     periods,
	}
}

// NewTerpPeriodicVestingAccount returns a new TerpPeriodicVestingAccount
func NewTerpPeriodicVestingAccount(baseAcc *authtypes.BaseAccount, originalVesting sdk.Coins, periods Periods) *TerpPeriodicVestingAccount {
	if len(periods) == 0 {
		return &TerpPeriodicVestingAccount{}
	}
	...
	for _, p := range periods {
		endTime = terputils.Max64(endTime, p.StartTime+p.Length)
	}
...
func (pva *TerpPeriodicVestingAccount) AddNewGrant(grantedPeriod Period) {
	...
	pva.EndTime = terputils.Max64(pva.EndTime, grantedPeriod.Length+grantedPeriod.StartTime)
	pva.OriginalVesting = pva.OriginalVesting.Add(grantedPeriod.Amount...)
}

// GetVestedCoins returns the total number of vested coins. If no coins are vested,
// nil is returned.
func (pva TerpPeriodicVestingAccount) GetVestedCoins(blockTime time.Time) sdk.Coins {
	...
	for _, period := range pva.VestingPeriods {
		vestedCoins = vestedCoins.Add(terputils.GetVestedCoinsAt(blockTime.Unix(), period.StartTime, period.Length, period.Amount)...)
	}
...
func (pva TerpPeriodicVestingAccount) GetVestingCoins(blockTime time.Time) sdk.Coins {
	return pva.OriginalVesting.Sub(pva.GetVestedCoins(blockTime)...)
}

// LockedCoins returns the set of coins that are not spendable (i.e. locked),
// defined as the vesting coins that are not delegated.
func (pva TerpPeriodicVestingAccount) LockedCoins(blockTime time.Time) sdk.Coins {
...
func (pva *TerpPeriodicVestingAccount) TrackDelegation(blockTime time.Time, balance, amount sdk.Coins) {
...
// account.
func (pva TerpPeriodicVestingAccount) GetStartTime() int64 {
	return pva.VestingPeriods[0].StartTime
}

// GetVestingPeriods returns vesting periods associated with periodic vesting account.
func (pva TerpPeriodicVestingAccount) GetVestingPeriods() Periods {
	return pva.VestingPeriods
}

// Validate checks for errors on the account fields
func (pva TerpPeriodicVestingAccount) Validate() error {
...
func (pva TerpPeriodicVestingAccount) String() string {
	out, _ := pva.MarshalYAML()
	return out.(string)
}

// MarshalYAML returns the YAML representation of a TerpPeriodicVestingAccount.
func (pva TerpPeriodicVestingAccount) MarshalYAML() (interface{}, error) {
