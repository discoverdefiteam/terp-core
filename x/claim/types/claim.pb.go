...
func init() {
	proto.RegisterEnum("terp.claim.Action", Action_name, Action_value)
	proto.RegisterType((*ClaimRecord)(nil), "terp.claim.ClaimRecord")
}

func init() { proto.RegisterFile("terp/claim/claim.proto", fileDescriptor_b4747d999b9dc0da) }
