...
import (
	context "context"
	fmt "fmt"
	types1 "github.com/terpnetwork/terp-core/x/claim/vesting/types"
...
type QueryClaimableForActionRequest struct {
	AirdropIdentifier string `protobuf:"bytes,1,opt,name=airdrop_identifier,json=airdropIdentifier,proto3" json:"airdrop_identifier,omitempty" yaml:"airdrop_identifier"`
	Address           string `protobuf:"bytes,2,opt,name=address,proto3" json:"address,omitempty" yaml:"address"`
	Action            Action `protobuf:"varint,3,opt,name=action,proto3,enum=terp.claim.Action" json:"action,omitempty" yaml:"action"`
}
...
func init() {
	proto.RegisterType((*QueryDistributorAccountBalanceRequest)(nil), "terp.claim.QueryDistributorAccountBalanceRequest")
	proto.RegisterType((*QueryDistributorAccountBalanceResponse)(nil), "terp.claim.QueryDistributorAccountBalanceResponse")
	proto.RegisterType((*QueryParamsRequest)(nil), "terp.claim.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "terp.claim.QueryParamsResponse")
	proto.RegisterType((*QueryClaimRecordRequest)(nil), "terp.claim.QueryClaimRecordRequest")
	proto.RegisterType((*QueryClaimRecordResponse)(nil), "terp.claim.QueryClaimRecordResponse")
	proto.RegisterType((*QueryClaimableForActionRequest)(nil), "terp.claim.QueryClaimableForActionRequest")
	proto.RegisterType((*QueryClaimableForActionResponse)(nil), "terp.claim.QueryClaimableForActionResponse")
	proto.RegisterType((*QueryTotalClaimableRequest)(nil), "terp.claim.QueryTotalClaimableRequest")
	proto.RegisterType((*QueryTotalClaimableResponse)(nil), "terp.claim.QueryTotalClaimableResponse")
	proto.RegisterType((*QueryUserVestingsRequest)(nil), "terp.claim.QueryUserVestingsRequest")
	proto.RegisterType((*QueryUserVestingsResponse)(nil), "terp.claim.QueryUserVestingsResponse")
}

func init() { proto.RegisterFile("terp/claim/query.proto", fileDescriptor_baa87682a02846df) }
...
func (c *queryClient) DistributorAccountBalance(ctx context.Context, in *QueryDistributorAccountBalanceRequest, opts ...grpc.CallOption) (*QueryDistributorAccountBalanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/terp.claim.Query/DistributorAccountBalance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/terp.claim.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ClaimRecord(ctx context.Context, in *QueryClaimRecordRequest, opts ...grpc.CallOption) (*QueryClaimRecordResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/terp.claim.Query/ClaimRecord", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ClaimableForAction(ctx context.Context, in *QueryClaimableForActionRequest, opts ...grpc.CallOption) (*QueryClaimableForActionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/terp.claim.Query/ClaimableForAction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TotalClaimable(ctx context.Context, in *QueryTotalClaimableRequest, opts ...grpc.CallOption) (*QueryTotalClaimableResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/terp.claim.Query/TotalClaimable", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) UserVestings(ctx context.Context, in *QueryUserVestingsRequest, opts ...grpc.CallOption) (*QueryUserVestingsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/terp.claim.Query/UserVestings", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_DistributorAccountBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/terp.claim.Query/DistributorAccountBalance",
	}
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/terp.claim.Query/Params",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ClaimRecord_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/terp.claim.Query/ClaimRecord",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ClaimableForAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/terp.claim.Query/ClaimableForAction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_TotalClaimable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/terp.claim.Query/TotalClaimable",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_UserVestings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/terp.claim.Query/UserVestings",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "terp/claim/query.proto",
}
