...
func NewTerpApp(
	...
	// For terpd we use the demo controller from https://github.com/cosmos/interchain-accounts but see notes below
...
func (app *TerpApp) ModuleConfigurator() module.Configurator {
...
func (app *TerpApp) LegacyAmino() *codec.LegacyAmino { //nolint:staticcheck
